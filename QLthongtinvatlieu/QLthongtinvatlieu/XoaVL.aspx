<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XoaVL.aspx.cs" Inherits="QLthongtinvatlieu.XoaVL" %>
...
<!DOCTYPE html>
    ...
    <form id="form2" runat="server">
        <div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="btnXoavl" runat="server" style="text-align: center" Text="Xóa thông tin vật liệu"></asp:Label>
            <br />
            <br />
            ...
            <asp:Button ID="btnxoa" runat="server" Text="Xóa vật liệu" OnClick="btnxoa_Click" />
